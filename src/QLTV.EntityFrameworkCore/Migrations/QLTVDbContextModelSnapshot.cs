...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QLTV.ThuVien.Author", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("AppAuthors", "Library");
                });

            modelBuilder.Entity("QLTV.ThuVien.Block", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("NumberBookInBlock")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.ToTable("AppBlocks", "Library");
                });

            modelBuilder.Entity("QLTV.ThuVien.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppBooks", "Library");
                });

            modelBuilder.Entity("QLTV.ThuVien.Borrow", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppBorrows", "Library");
                });

            modelBuilder.Entity("QLTV.ThuVien.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppCategories", "Library");
                });

            modelBuilder.Entity("QLTV.ThuVien.Example", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppExamples");
                });

            modelBuilder.Entity("QLTV.ThuVien.Reader", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QLTV.ThuVien.Book", b =>
                {
                    b.HasOne("QLTV.ThuVien.Author", "AuthorBook")
                        .WithMany("AuthorBooks")
                        .HasForeignKey("IdAuthor")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QLTV.ThuVien.Block", "BlockBook")
                        .WithMany("BlockBooks")
                        .HasForeignKey("IdBlock")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QLTV.ThuVien.Category", "CategoryBook")
            ...
            modelBuilder.Entity("QLTV.ThuVien.Borrow", b =>
                {
                    b.HasOne("QLTV.ThuVien.Book", "BookBorrow")
                        .WithMany("BookBorrows")
                        .HasForeignKey("IdBook")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QLTV.ThuVien.Reader", "ReaderBorrow")
